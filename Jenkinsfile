      ...
      ''') {
        stage('Populate DB_2.5.5-3.0') {
          ...
          // dir('core') {
            ...
            sh 'RAILS_ENV=development BUNDLE_GEMFILE=GemfileMriAwsDigest BUNDLE_USER_HOME=/root BUNDLE_PATH=/home/cloudhealth/bundle/ bundle exec rake db:schema:load db:seed'
